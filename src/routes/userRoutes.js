...
router.get("/alluser", Auth.authenticateUser, Auth.authorizeAdmin, UserController.getAllUsers);
router.delete("/delete/:idUser", Auth.authenticateUser, Auth.authorizeAdmin, UserController.deleteUserAdmin);
